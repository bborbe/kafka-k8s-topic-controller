...
import (
	...
	versioned "github.com/bborbe/kafka-k8s-topic-controller/k8s/client/clientset/versioned"
	internalinterfaces "github.com/bborbe/kafka-k8s-topic-controller/k8s/client/informers/externalversions/internalinterfaces"
	v1 "github.com/bborbe/kafka-k8s-topic-controller/k8s/client/listers/kafka.benjamin-borbe.de/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KafkaV1().Topics(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KafkaV1().Topics(namespace).Watch(options)
			},
		},
		&kafkabenjaminborbedev1.Topic{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *topicInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kafkabenjaminborbedev1.Topic{}, f.defaultInformer)
}
