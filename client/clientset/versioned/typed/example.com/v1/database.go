...
import (
	...
	v1 "github.com/bborbe/kafka-k8s-topic-controller/apis/example.com/v1"
	scheme "github.com/bborbe/kafka-k8s-topic-controller/client/clientset/versioned/scheme"
...
type DatabaseInterface interface {
	...
	Get(name string, options metav1.GetOptions) (*v1.Database, error)
	List(opts metav1.ListOptions) (*v1.DatabaseList, error)
...
func (c *databases) Get(name string, options metav1.GetOptions) (result *v1.Database, err error) {
	result = &v1.Database{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("databases").
...
func (c *databases) List(opts metav1.ListOptions) (result *v1.DatabaseList, err error) {
...
func (c *databases) Watch(opts metav1.ListOptions) (watch.Interface, error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
...
func (c *databases) Delete(name string, options *metav1.DeleteOptions) error {
...
func (c *databases) DeleteCollection(options *metav1.DeleteOptions, listOptions metav1.ListOptions) error {
	var timeout time.Duration
